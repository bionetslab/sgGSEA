...
# load label mappings
# @LIZA: if you want to change the names in the legend, you need to open the file "mappings.json" and change them there
...
# @LIZA: here you can change things like fontsize or title or where the file will be saved
